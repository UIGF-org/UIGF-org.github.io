...
<RelativeProjectPanel>
  <Pcd
    ...
    import export>
    <template #import>
      <Pcb label="UIGF v4.2" :games="['ys', 'qx', 'sr_', 'zzz_']" bg="orange"></Pcb>
  ...
  <Pcd
    ...
    title="Neko Game"
    desc="Duration Records, Genshin Impact、ZZZ and Honkai: Star Rail Gacha Record Analysis Tool"
    import export>
    <template #import>
 ...
 <Pcd
  ...
  <Pcd
    ...
    desc="A tool to help record gacha history"
    import export>
    <template #import>
