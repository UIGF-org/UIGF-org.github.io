import{_ as e,r as a,o as i,c,d as n,b as s,a as t,e as u}from"./app-YMhdR1CZ.js";const r={},l=n("h1",{id:"星穹铁道抽卡记录标准-v1-0",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#星穹铁道抽卡记录标准-v1-0"},[n("span",null,"星穹铁道抽卡记录标准 v1.0")])],-1),d={class:"hint-container warning"},k=n("p",{class:"hint-container-title"},"SRGF 标准使用声明",-1),q=n("strong",null,"导入",-1),v=n("strong",null,"导出",-1),m={href:"https://uigf.org",target:"_blank",rel:"noopener noreferrer"},g=n("p",null,"仅包含导入或导出功能降低了用户数据可流通性，且将数据置于用户不可控的风险中，不符合 UIGF-Org 设计的初衷。",-1),b=u(`<h2 id="json-示例" tabindex="-1"><a class="header-anchor" href="#json-示例"><span>Json 示例</span></a></h2><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code><span class="token punctuation">{</span>
