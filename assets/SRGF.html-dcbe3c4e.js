import{_ as e,r as a,o as i,c as u,a as n,b as s,d as t,e as c}from"./app-33ca463a.js";const l={},r=n("h1",{id:"星穹铁道抽卡记录标准-v1-0",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#星穹铁道抽卡记录标准-v1-0","aria-hidden":"true"},"#"),s(" 星穹铁道抽卡记录标准 v1.0")],-1),k={class:"hint-container warning"},d=n("p",{class:"hint-container-title"},"SRGF 标准使用声明",-1),q=n("strong",null,"导入",-1),v=n("strong",null,"导出",-1),m={href:"https://uigf.org",target:"_blank",rel:"noopener noreferrer"},b=n("p",null,"仅包含导入功能降低了用户数据可流通性，且将数据至于用户不可控的风险中，不符合 UIGF-Org 设计的初衷。",-1),g=c(`<h2 id="json-示例" tabindex="-1"><a class="header-anchor" href="#json-示例" aria-hidden="true">#</a> Json 示例</h2><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
